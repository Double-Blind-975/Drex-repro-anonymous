...
file_path = "plot/drex_only/10_most_used_nodes_MEVA_merged_365_0.9999_1_max0/output_drex_only_10_most_used_nodes_MEVA_merged_1.csv"
...
df['algorithm'] = df['algorithm'].str.replace('hdfs_3_replication_c', '3 Replication')
...
df['algorithm'] = df['algorithm'].str.replace('alg_drexlb', 'D-Rex LB')
...
df['algorithm'] = df['algorithm'].str.replace('least_used_node', 'GreedyLeastUsed')
...
for algorithm in algorithms:
    ...
    print(summed_times['total_parralelized_upload_time']/dividor + summed_times['total_read_time_parrallelized']/dividor + summed_times['total_chunking_time']/dividor + summed_times['total_reconstruct_time']/dividor)
